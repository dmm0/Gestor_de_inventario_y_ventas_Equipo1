...
CREATE TABLE `Detalle_Cotizacion` (
  ...
  KEY `fk_cotizacion_producto_idx` (`id_producto`),
  KEY `fk_Dcotizacion_cotizacion_idx` (`id_cotizacion`),
  CONSTRAINT `fk_Dcotizacion_cotizacion` FOREIGN KEY (`id_cotizacion`) REFERENCES `Cotizacion` (`id_cotizacion`),
  CONSTRAINT `fk_Dcotizacion_producto` FOREIGN KEY (`id_producto`) REFERENCES `Productos` (`id_productos`)
...
-- Dump completed on 2026-05-08 17:38:10
